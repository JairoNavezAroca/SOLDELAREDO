...
<?php 
	...
	if (isset($_GET['id'])) {
		...
		$dpm = DetallePropMejora::where('IdPropMejora',$pm->IdPropMejora)->get()->reverse();
	}
	else
...
<div class="right_col" role="main">
	<br>
	<h1 class="text-center">Ver Propuesta de Mejora(Historial de cambios)</h1>
	<br>
	<div class="col-md-12 col-sm-12 col-xs-12">
		<!-- start accordion -->
		<div class="accordion" id="accordion" role="tablist" aria-multiselectable="true">
			<?php $i = 1 ?>
			<?php foreach ($dpm as $item): ?>
				<div class="panel">
				...
				<div id="panel_<?php echo $i ?>" class="panel-collapse collapse" role="tabpanel" aria-labelledby="p_<?php echo $i ?>">
					<div class="panel-body">
						...
						<div class="text-center">
							<a href="../controlador/Productividad_PropMejora_Exportar_Version.php?id=<?php echo $item->IdDetallePropMejora ?>&Word" target="__blank">Exportar a Word</a>
							&nbsp&nbsp|&nbsp&nbsp
							<a href="../controlador/Productividad_PropMejora_Exportar_Version.php?id=<?php echo $item->IdDetallePropMejora ?>&PDF" target="__blank">Exportar a PDF</a>
						</div>
					</div>
				</div>
			</div>
