...
<div id="page-content" hidden="">
	<?php ob_start(); ?>
	<?php foreach ($er as $item_er): ?>
		<?php 
			$der = DetalleEvRendimiento::where('IdEvRendimiento',$item_er->IdEvRendimiento)->where('Estado',true)->first();
			$e = Personal::find($item_er->DniPersonal);
		 ?>
